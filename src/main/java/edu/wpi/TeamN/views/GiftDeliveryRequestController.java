...
@Slf4j
public class GiftDeliveryRequestController extends MasterController implements Initializable {
  ...
  public void help(ActionEvent actionEvent) throws IOException {
    dialogFactory.creatDialogOkay(
        "Help",
        "- Employee Name refers to the employee being requested to complete the job \n- Patient Room is the room with the patient where the gift is required \n- Time of request refers to time at which the gift is needed \n- Gift type refers to the kind of gift that a patient would like to receive \n- Comments refers to any additional information needed");
  }
