...
public class Ndb {
  ...
  private static void updateNode() {
    try {
      ...
      System.out.println("Enter new X Y (ex. 100 200): ");
  ...
  private static void printResultSet(ResultSet r)
      throws SQLException { // TODO MAKE LOOK NICE (45 char spots is a lot)
