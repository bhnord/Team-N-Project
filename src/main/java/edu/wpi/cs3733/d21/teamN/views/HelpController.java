...
@Slf4j
public class HelpController extends MasterController implements Initializable {

  @com.google.inject.Inject DatabaseService db;
  @com.google.inject.Inject FXMLLoader loader;
  @com.google.inject.Inject HomeState state;
  @FXML private Label tt;
